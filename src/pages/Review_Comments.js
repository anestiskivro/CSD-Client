...
function Review_comments() {
    ...
    useEffect(() => {
        axios.get(`${process.env.REACT_APP_API_URL}/tassistant/getComments`)
            .then((response) => {
                if (response.status === 200) {
                    ...
                    return axios.get(`${process.env.REACT_APP_API_URL}/tassistant/getExams`);
                } else {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}/tassistant`)
            .then((response) => {
                if (response.status === 200) {
                    setCourses(response.data.data);
                    return axios.get(`${process.env.REACT_APP_API_URL}/teacher/getTAs`, { params: { selectedCourse: response.data.data } });
                } else {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}/tassistant/getStudents`)
            .then((response) => {
                if (response.status === 200) {
