...
function StudentsSlots() {
    ...
    useEffect(() => {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}/teacher/getExams`, { params: { selectedCourse: selectedCourse } }).then((response) => {
            if (response.status === 200) {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}/teacher/getTAs`, { params: { selectedCourse: selectedCourse } }).then((response) => {
            if (response.status === 200) {
    ...
    const handleOptions = (event) => {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}/teacher/getStudentsSlots`, { params: { selectedCourse: selectedCourse, selectedExam: examName } }).then((response) => {
            if (response.status === 200) {
